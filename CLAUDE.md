...
**2026 VM-tips** is a multiplayer FIFA World Cup 2026 score prediction game. Users sign up, create or join groups via invite codes, and predict the exact scores of WC 2026 group-stage matches. Predictions are scored automatically when matches complete:
...
│   │   ├── races/         # Match list + detail pages
│   │   │   └── [id]/      # Match detail with PredictionForm
...
│   ├── PredictionForm.tsx  # Score input + group selector, locks after kick-off
...
│   ├── scoring.ts          # Pure scoring math (calculateScore, getResult)
